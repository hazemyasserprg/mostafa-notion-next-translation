...
function ScreenshotsDetails() {
  return (
    ...
    p-6 sm:p-12 flex flex-col lg:flex-row items-center justify-between gap-20
    shadow-2xl"
      >
        {/* Text */}
      ...
      {/* === Blocks 3 + 4 in a horizontal row === */}
